                                        ...
                                        @foreach ($patients as $item)   
                                            <tr class="odd:bg-white even:bg-gray-50 border-b border-gray-200 hover:bg-gray-100">
                                                ...
                                                <td class="py-3 px-6 text-left ">
                                                        ...
                                                        <h1 class="font-medium">{{$item->surname}}, {{$item->name}}</h1>
                                                ...
                                                <td class="py-3 px-6 text-left ">                                     
                                                    <h1 class="font-medium">{{$item->document }}-{{$item->number }}</h1> 
                                                </td>
...
<script>
    Livewire.on('deletePatient',patientId=>{
      Swal.fire({
              ...
              if (result.value) {
                  Livewire.emitTo('patient.patient-index','delete',patientId);
                  Swal.fire(
                  'Eliminado!',
