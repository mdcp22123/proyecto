       ...
       <div class="separator" >
        <p  >-------Detalle General--------</p>
           ...
           <div >
                ...
                <h4 style="margin-top: -10px">INGRESOS <samp style="margin-left:69px">S/.{{$box->income}}</samp></h4>
     
    
            <h4 style="margin-top: -10px">EGRESOS(GASTOS) <samp style="margin-left:15px">S/.{{$box->expenses}}</samp></h4>
        ...
        <div >
            ...
            <h4 style="margin-top: -10px">INGRESOS TOTALES <samp style="margin-left:20px">S/.{{$box->income}}</samp></h4>
  

        <h4 style="margin-top: -10px">EGRESOS TOTALES <samp style="margin-left:28px">S/.{{$box->expenses}}</samp></h4>


    <h4 style="margin-top: -10px">SALDO <samp style="margin-left:107px">S/.{{$box->balance}}</samp></h4>
    <h5 style="margin-top: -10px">MONTO INICIAL+SALDO <samp style="margin-left:15px; font-size: 13px"> S/.{{$box->final}}</samp></h5>
